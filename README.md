...
$ sudo docker build -t azure-pipelines-agents-debian-10.13:31032023 .
```
...
```
docker build -t azure-pipelines-agents-debian-10.13:31032023 .
```
or on Ubuntu image.
```
docker build -t azure-pipelines-agents-debian-10.13:31032023 .
...
```
docker build -t azure-pipelines-agents-playwright-1.32.0:31032023 .
```
...
docker run -v /var/run/docker.sock:/var/run/docker.sock \
    ...
    -e AZP_POOL=Default -e AZP_WORK=_work --name 01_Debian-10.13 azure-pipelines-agents-debian-10.13:31032023
```
