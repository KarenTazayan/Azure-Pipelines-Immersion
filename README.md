...
```
docker build -t azure-pipelines-agents-debian-12.2:11072024 .
```
or on Ubuntu image.
```
docker build -t azure-pipelines-agents-ubuntu-20.04:11072024 .
```
Also create Playwright image
```
docker build -t azure-pipelines-agents-playwright-1.x:1.45.0.11072024 .
```
