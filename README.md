...
```
docker build -t azure-pipelines-agents-debian-12.2:07052024 .
```
or on Ubuntu image.
```
docker build -t azure-pipelines-agents-ubuntu-20.04:07052024 .
```
Also create Playwright image
```
docker build -t azure-pipelines-agents-playwright-1.x:1.43.0.07052024 .
```
