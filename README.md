...
```
docker build -t azure-pipelines-agents-debian-12.2:15032024 .
```
or on Ubuntu image.
```
docker build -t azure-pipelines-agents-ubuntu-20.04:15032024 .
```
Also create Playwright image
```
docker build -t azure-pipelines-agents-playwright-1.42.0:15032024 .
```
