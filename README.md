...
$ sudo docker build -t azure-pipelines-agents-debian-12.12:18092025 .
```
...
```
docker build -t azure-pipelines-agents-debian-12.12:18092025 .
```
or on Ubuntu image.
```
docker build -t azure-pipelines-agents-ubuntu-24.04:18092025 .
```
Also create Playwright image
```
docker build -t azure-pipelines-agents-playwright-1.x:1.55.0.18092025 .
```
