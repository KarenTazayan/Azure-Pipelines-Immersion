...
$ sudo docker build -t azure-pipelines-agents-debian-12.2:22042024 .
```
...
```
docker build -t azure-pipelines-agents-debian-12.2:22042024 .
```
or on Ubuntu image.
```
docker build -t azure-pipelines-agents-ubuntu-20.04:22042024 .
```
Also create Playwright image
```
docker build -t azure-pipelines-agents-playwright-1.42.0:22042024 .
```
...
docker run --rm -v /var/run/docker.sock:/var/run/docker.sock \
    ...
    -e AZP_POOL=Default -e AZP_WORK=_work --name 01_debian-12.2 azure-pipelines-agents-debian-12.2:22042024
```
