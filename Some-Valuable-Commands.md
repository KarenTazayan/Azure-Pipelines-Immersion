...
```
sudo docker tag [image id] [account or namespace]/azure-pipelines-agents-debian-12.12:30042026
sudo docker push [account or namespace]/azure-pipelines-agents-debian-12.12:30042026
```
