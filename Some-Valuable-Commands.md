...
```
sudo docker tag [image id] [account or namespace]/azure-pipelines-agents-debian-12.7:18092024
sudo docker push [account or namespace]/azure-pipelines-agents-debian-12.7:18092024
```
