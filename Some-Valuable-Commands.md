...
```
sudo docker tag [image id] [account or namespace]/azure-pipelines-agents-debian-12.7:15052025
sudo docker push [account or namespace]/azure-pipelines-agents-debian-12.7:15052025
```
